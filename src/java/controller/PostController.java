...
public class PostController implements Serializable {
    ...
    private entities.Post current;
    private DataModel items = null;
    @EJB
    private facades.PostFacade ejbFacade;
    ...
    public entities.Post getSelected() {
        if (current == null) {
            current = new entities.Post();
            selectedItemIndex = -1;
        }
        return current;
    }

    private facades.PostFacade getFacade() {
        return ejbFacade;
    }
